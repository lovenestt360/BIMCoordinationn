      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0F172A;color:#F8FAFC;padding:32px;border-radius:8px;">
            <h2 style="color:#0EA5E9;margin-top:0;">New Contact Message</h2>
            <table style="width:100%;border-collapse:collapse;">
              ...
              <tr>
                <td style="padding:12px 8px;color:#94A3B8;vertical-align:top;">Message</td>
                <td style="padding:12px 8px;line-height:1.6;">${record.message}</td>
              </tr>
            </table>
