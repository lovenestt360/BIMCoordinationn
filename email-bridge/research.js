...
export function registerResearchRoutes(app){
 ...
 app.get('/api/process-research',async(req,res)=>{
  ...
  const limit=Math.max(1,Math.min(40,Number(req.query.limit)||40));const summary={selected:0,researched:0,qualified:0,errors:[]};
  try{
